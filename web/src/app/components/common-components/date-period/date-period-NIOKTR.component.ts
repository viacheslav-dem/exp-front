...
export const PERIOD_FILTER_CONTROL_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => DatePeriodNIOKTRComponent),
    multi: true
};

@Component({
    selector: 'app-date-period-NIOKRT',
    template: `
    <ng-container>
...
export class DatePeriodNIOKTRComponent extends ControlComponent<DateRange> {
