    ...
    <div class="form-sub-group">
      ...
      @if (full()) {
        <textarea
          ...
          [name]="'constructionWorksText_' + num().split('.').join('_')"
          required
          minlength="30"
          maxlength="5000"
          rows="3"
...
export class ConstructionWorkBlock2025Component {
    ...
    readonly _form = input<ConstructionWorkBlock2025Form>(undefined);

    readonly onConditionsChanged = output<boolean>();
    readonly formPatch = output<Partial<ConstructionWorkBlock2025Form>>();

    emitPatch(patch: Partial<ConstructionWorkBlock2025Form>) {
    ...
    stateButton(flag: boolean){
        this.emitPatch({ constructionWorks: flag });
    }
}

type ConstructionWorkBlock2025Form = {
