...
@Component({
    ...
    template: `
        <div class="form-sub-group">
          ...
          <input type="hidden" [(ngModel)]="_form().socioEconomic" name="socioEconomic" required>
          ...
          @if (full()) {
            <textarea [(ngModel)]="_form().socioEconomicText" name="socioEconomicText" required minlength="30" rows="3" class="form-control mt-05"
