...
@Component({
    ...
    <div *ngIf="full" class="hint">
        <p>
            <b>Подсказка.</b>
            Решение о соответствии заявленному программному инструменту выполнения научных исследований и разработок принимается 
            при соответствии объектов государственной экспертизы 8.1 и 8.3 следующей схеме:
            <p>- фундаментальные научные исследования – в рамках государственных программ научных исследований;</p>
            <p>- прикладные научные исследования и разработки – в рамках научно-технических программ.</p>
    </div>
  `
})
