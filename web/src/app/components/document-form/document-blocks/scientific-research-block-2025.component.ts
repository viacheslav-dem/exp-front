    ...
    <div class="form-sub-group">
      ...
      <div *ngIf="full" class="hint">
        <p>
          ...
          <p>
              В случае, если научное исследование по объекту государственной экспертизы предлагается заказчиком экспертизы для выполнения 
              в рамках научно-технической программы или государственной программы (в качестве мероприятия по научному обеспечению) 
              и при этом является фундаментальным научным исследованием, эксперту необходимо рекомендовать его реализацию в рамках 
