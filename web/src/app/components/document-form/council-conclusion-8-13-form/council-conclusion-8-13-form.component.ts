...
export class CouncilConclusion_8_13_FormComponent extends CouncilConclusionForm {
    ...
    private validationCommentsOnConclusion() {
        ...
        if (this._form.programRequirements) {
            throw "В пункте 'Соответствие требованиям, указанным в Положении о порядке реализации государственных программ:' не выставлено заключение.";
        }
        ...
        if (this._form.prognosis) {
            throw "В пункте 'Оценка анализа текущего состояния и прогноза научно-технического развития соответствующей сферы планирования:' не выставлено заключение.";
        }
        ...
        if (this._form.targetAnalysis) {
            throw "В пункте 'Анализ целевых показателей:' не выставлено заключение.";
        }
        ...
        if (this._form.programSufficiency) {
            throw "В пункте 'Достаточность перечня мероприятий по научному обеспечению государственной программы / перечня заданий государственной научно-технической программы для достижения запланированных программой целевых показателей:' не выставлено заключение.";
        }
        ...
        if (this._form.financeConclusion) {
            throw "В пункте 'Достаточность перечня мероприятий по научному обеспечению государственной программы / перечня заданий государственной научно-технической программы для достижения запланированных программой целевых показателей:' не выставлено заключение.";
        }
